...
class Risk::Referee::CrossRefinQuantityTest < ActiveSupport::TestCase
  test '.call returns a green flag and ignores refin_quantity_delta' do
    key_indicators = {
      '00000' => {
        'refin_value_delta' => {
          'evidence' => {
    ...
    decorated_evidences.each_cnpj do |cnpj, evidence|
      assert_equal expected, Risk::Referee::CrossRefinQuantity.new(evidence).call
    end
  end

  test '.call returns a yellow flag and do not ignore refin_quantity_delta because it has a red_flag' do
    key_indicators = {
      '00000' => {
        'refin_value_delta' => {
          'evidence' => {
  ...
  test '.call returns a green flag and do not ignore refin_quantity_delta because it has a green_flag' do
    key_indicators = {
      '00000' => {
        'refin_value_delta' => {
          'evidence' => {
