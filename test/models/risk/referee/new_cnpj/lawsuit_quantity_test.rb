...
class Risk::Referee::NewCNPJ::LawsuitQuantityTest < ActiveSupport::TestCase
  test '.assert should create yellow flag' do
    ...
    assert_equal expected, Risk::Referee::NewCNPJ::LawsuitQuantity.new(decorated_evidences).assert
  end
