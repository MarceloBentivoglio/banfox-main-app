...
class Risk::Referee::AdminRefinQuantityDeltaTest < ActiveSupport::TestCase
  test '.call returns a collection of key_indicators' do
    ...
    referee = Risk::Referee::AdminRefinQuantityDelta.new(decorated_evidence)

    expected = [
      {
        code: 'admin_refin_quantity_delta_0000000001',
      ...
      {
        code: 'admin_refin_quantity_delta_0000000002',
        title: 'Admin Refin Quantity Delta',
